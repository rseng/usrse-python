...
# -*- coding: utf-8 -*-
#
# usrse documentation build configuration file, created by
...
project = "US-RSE Python"
copyright = "2022, Vanessa Sochat"

from usrse import version
...
latex_documents = [
    ("index", "usrse.tex", "usrse Documentation", "Vanessa Sochat", "manual"),
]
...
texinfo_documents = [
    (
        ...
        ["Vanessa Sochat"],
        "usrse",
        "usrse is a tool for measuring and assessing change in packages.",
        "Miscellaneous",
    ),
]
